...
from evidence_pattern_retrieval.BERT_Ranker.BertRanker import BertForCandidateRanking
...
def register_args(parser):
    ...
    # train curriculum
    parser.add_argument("--training_curriculum", default="random", type=str,
                        choices=["random", "bootstrap", "mixbootstrap"])
    parser.add_argument("--bootstrapping_start", default=None, type=int, help="when to start bootstrapping sampling")
    parser.add_argument("--bootstrapping_ticks", default=None, type=str,
                        help="when to update scores for bootstrapping in addition to the startpoint")

    # textualizing choices
    parser.add_argument("--linear_method", default="vanilla", type=str,
                        choices=["vanilla", "naive_text", "reduct_text"])
    parser.add_argument('--add_special_tokens', default=False, action='store_true', help='True when use [CVT]')
    parser.add_argument("--sample_size", type=int, default=None, required=True, help="sample size for cross encoder")
    parser.add_argument("--topk", type=int, default=None, required=True, help="topk lp for generating ep")
